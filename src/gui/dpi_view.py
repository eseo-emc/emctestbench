...
#
# Created: Wed May 16 17:32:50 2012
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frequencyMinimum = QuantityWidgetController(Form)
        ...
        self.powerMinimum = PowerWidgetController(Form)
        self.powerMinimum.setObjectName(_fromUtf8("powerMinimum"))
        self.gridLayout.addWidget(self.powerMinimum, 1, 3, 1, 2)
        ...
        self.frequencyMaximum = QuantityWidgetController(Form)
        ...
        self.powerMaximum = PowerWidgetController(Form)
        self.powerMaximum.setObjectName(_fromUtf8("powerMaximum"))
        self.gridLayout.addWidget(self.powerMaximum, 2, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.searchMethod, 3, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.saveTransmittedPowers, 4, 3, 1, 1)
...
from quantitywidget_controller import QuantityWidgetController
